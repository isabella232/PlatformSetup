...
class Input extends BaseComponent {
	...
	getTemplate(){ return React.createElement("div", {className: Tools.classSet(this.state.css)},     React.createElement("input", {disabled: this.props.disabled, type: "text", className: "form-control", valueLink: this.props.valueLink, placeholder: this.props.placeholder}));}

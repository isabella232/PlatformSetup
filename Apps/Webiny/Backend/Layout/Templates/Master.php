    ...
    <script>
        ...
        System.import('Webiny/Webiny').then(function(module){
            ...
            // Build array of apps to load - this should be dynamic
            var modules = [System.import('Webiny/App'), System.import('Todo/App')];
            ...
            Q.all(modules).then(function(apps) {
                ...
                System.import('Webiny/Layout/Components/App').then(function(module){
                    ...
                    var mainComponent = React.createElement(module.default.createComponent());
